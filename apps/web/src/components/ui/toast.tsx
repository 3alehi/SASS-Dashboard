...
const toastVariants = cva(
  'group pointer-events-auto relative flex w-full items-start justify-between gap-3 overflow-hidden rounded-lg border p-4 shadow-panel transition-all data-[state=open]:animate-slide-in-from-top',
  {
    variants: {
      variant: {
